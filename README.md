...
Discord launched their new "Active Developer" badge and they're encouraging new developers to join the community and get it.
...
- Click this badge to clone this repo to a new repl in Replit -> [![Run on Repl.it](https://replit.com/badge/github/saabrr/discord-active-developer-badge)](https://replit.com/github/saabrr/developer-badge)
...
If you're encountering any issues, [create a new GitHub issue]() or join [this](https://discord.gg/saabrg) server and ping me in the `#general` channel.


--------------------------------------

# Star the repo!!!
If you were able to successfully get the badge from this, star this repository so more people can see it and feel free to join our Discord server: https://discord.gg/saabrg
